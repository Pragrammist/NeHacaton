...
namespace HendInRentApi
{
    public class InventoryRepositoryApi
    {
        ...
        /// <returns></returns>
        public async Task<OutputHIRAInventoriesResultDto> PostInvetoryItems(string token, InputHIRAInventoryDto? requestData = null)
        {
            ...
            var result = await response.Content.ReadJsonByNewtonsoft<OutputHIRAInventoriesResultDto>() ?? throw new NullReferenceException("result of HttpContent.ReadFromJsonAsync is null");
