...
{
    public class OutputHERARentDto
    {
        ...
        public OutputHERARentStateDto RentState { get; set; } = null!;
        //public List<object> Payments { get; set; }
        public List<OutputHERAInventoryDto> Inventories { get; set; } = new List<OutputHERAInventoryDto>();
        ...
        public OutputHERAAdminDto Admin { get; set; } = null!;
    }
}
